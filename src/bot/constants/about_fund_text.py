...
ABOUT_FUND_HISTORY = {
    ...
    'msg_3': (
        ...
        r'перераспределением и переработкой одежды на любой стадии ее жизни\.'
    ),
}
