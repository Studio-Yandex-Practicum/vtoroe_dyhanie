...
FUND_PROJECTS = {
    ...
    'msg_3': (
        'В 2021 году фонд ВТОРОЕ ДЫХАНИЕ открыл новое направление своей '
        'работы — общественную мастерскую в Москве. Это место, где любой '
        'желающий может починить сломавшиеся или устаревшие вещи, попробовать '
        'себя в дизайне и творчестве и узнать больше об осознанном '
        'потреблении.'
    ),
    'msg_4': (
