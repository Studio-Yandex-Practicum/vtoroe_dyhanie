...
ACC_PERSONS_LINK = (
    'https://docs.google.com/document/d/'
    '1PsLmtt44ZXiTJeBJEqgK-_j174HohSu6XpO5Diziats/edit?usp=sharing'
)
REG_VACATION_LINK = (
    'https://docs.google.com/document/d/12kzxJvoSon_tvdxqdP14qhUFYX6UnO2x/'
    'edit?usp=sharing&ouid=101141304038805869189&rtpof=true&sd=true'
)
TEMP_VACATION_LINK = (
    'https://drive.google.com/drive/folders/'
    '1XT2XHu29a9ZaTdhd6K9rfgwqTn1UqeNs?usp=sharing'
)
REG_BUSINESS_TRIP_LINK = (
    'https://docs.google.com/document/d/1jN80LdqesChmaVzsHCbnERHA60O5O1cK/'
    'edit?usp=sharing&ouid=101141304038805869189&rtpof=true&sd=true'
)
TEMP_BUSINESS_TRIP_LINK = (
    'https://drive.google.com/drive/folders/'
    '1zK0BCi8dSBxYwuuAprfmePTlTbhxNH22?usp=sharing'
)
REG_OFFER_LINK = (
    'https://docs.google.com/document/d/10qrj5MKW_3y1Izg141EAGHpNJMIW5NyC/'
    'edit?usp=sharing&ouid=101141304038805869189&rtpof=true&sd=true'
)
TEMP_OFFER_LINK = (
    'https://drive.google.com/drive/folders/'
    '17S4HZd5Ez2QoR2YuWA6649_GpiRv3Q62?usp=sharing'
)
REG_OTHR_OFFER_LINK = (
    'https://docs.google.com/document/d/1f8ebUki4gYHtlhRsDN_1C0sSisIi9HQV/'
    'edit?usp=sharing&ouid=101141304038805869189&rtpof=true&sd=true'
)
TEMP_OTHR_OFFER_LINK = (
    'https://drive.google.com/drive/folders/'
    '1NnY-8OGgDi41SVhpX_ocvYTQxNboY-mK?usp=sharing'
)
REG_FIRING_LINK = (
    'https://docs.google.com/document/d/1vMLG13Qs30zZ-VUTtrQ_QUegoHVL0BER/'
    'edit?usp=sharing&ouid=101141304038805869189&rtpof=true&sd=true'
)
TEMP_FIRING_LINK = (
    'https://drive.google.com/drive/folders/'
    '1JPk8bOSyYQ_jeLCAdHLmPQb_ICUeOoUo?usp=sharing'
)
REG_WEEKEND_LINK = (
    'https://docs.google.com/document/d/'
    '1qqFVBrboklfkvUuaWXx3szbexdksBHnqnqFckyB8NtQ/edit?usp=sharing'
)
REG_SALARY_LINK = (
    'https://docs.google.com/document/d/1f8ebUki4gYHtlhRsDN_1C0sSisIi9HQV/'
    'edit?usp=sharing&ouid=101141304038805869189&rtpof=true&sd=true'
