    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('constant_description', models.CharField(max_length=250, null=True, verbose_name='Описание')),
                ('constant_text', models.CharField(max_length=100, verbose_name='Текст внутри кнопки')),
